...
class SecretManager:
    def __init__(self, ega_inbox: str, project_id: str = "GDC-SUBMISSIONS", version_id: int = 1):
    ...
    def _get_secret_version_name(self) -> str:
        ...
        print(f"projects/{self.project_id}/secrets/{secret_id}/versions/{self.version_id}")
